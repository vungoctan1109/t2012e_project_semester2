...
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Mobile / Edit</li>
    </ol>
</div><!-- /.col -->
@endSection
@section('content')
        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control col-7" placeholder="Enter name..."
                        value="{{$mobile -> name}}">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="current_brand" value="{{$mobile -> brandID}}">
                    <select name="brandID" class="form-control col-4" id="brand">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="saleOff" class="form-control col-2" id="saleOff"
                        placeholder="Enter sale off..." value="{{$mobile -> saleOff}}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" list="colors" type="text" name="color" class="form-control col-3"
                        placeholder="Enter color..." value="{{$mobile -> color}}" />
                    <datalist id="colors">
                        <option>White</option>
                        <option>Gray</option>
                        <option>Black</option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" list="memories" name="memory" class="form-control col-2"
                        placeholder="Enter memory..." value="{{$mobile -> memory}}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="screenSize" class="form-control col-3" placeholder="Enter screen size..."
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div id="list-preview-image">
                            @php
                            $arrayThumbnail = $mobile->arrayThumbnail;
                            $stringArr = $mobile -> thumbnail . ',';
                            @endphp
                            @if($arrayThumbnail > 0)
                            @foreach($arrayThumbnail as $thumbnail)

                            <span class="m-2" id="preview-image"
                                style="position: relative; with:220px; display:inline-block;">
                                <img src="{{$thumbnail}}" alt="" class="img-thumbnail img-bordered"
                                    style="width: 220px; ml-2">
                                <i class="fas fa-times btnDeleteImg"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control col-7" rows="3"
                            placeholder="Enter description ...">{{$mobile -> description}}</textarea>
                        <span class="error description_error"></span>
                    </div>
                    <div class="form-group">
                        <label for="detail">Content detail</label>
                        <textarea name="detail" class="ck-editor__editable_inline"
                            id="editor">{{$mobile -> detail}}</textarea>
...
<script src="/dist/js/pages/mobile/edit_mobile.js"></script>
@endSection