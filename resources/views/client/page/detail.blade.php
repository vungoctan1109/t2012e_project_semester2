        ...
        <div class="row">
                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                            <ul class="slides">
                                @foreach ($product_current-> arrayThumbnail as $thumbnail)
                    ...
                    <div class="detail-info">
                        ...
                        <h2 class="product-name">{{$product_current-> name}}</h2>
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="/client-assets/assets/images/social-list.png"
                                    alt=""></a>
                        </div>
                        @php
                        $price_current = number_format($product_current -> price, 0, '', ',');
                        @endphp
                        <div class="wrap-price"><span class="product-price">{{$price_current}} (VND)</span>
                        </div>
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b>{{$product_current-> nameStatus}}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            ...
                            <a href="#add_infomation" class="tab-control-item">Item detail</a>
                            <a href="#review" class="tab-control-item">Reviews</a>
                        </div>
                        <div class="tab-contents">
                            <div class="tab-content-item active" id="description">
                                {{$product_current -> description}}
                            </div>
                            <div class="tab-content-item " id="add_infomation"
                                style="max-height: 600px; overflow: auto">
                                {!! $product_current -> content_detail !!}
                            </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget widget-product">
                    <h2 class="widget-title">Recent view</h2>
                    <div class="widget-content">
                        <ul class="products">
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="/client/page/detail/?id={{$product_related -> id}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="{{$product_related -> defaultThumbnail }}" width="214"
                                                height="214" alt="{{$product_related -> name}}"></figure>
                                    </a>
                                    <div class="group-flash">
                                        <span class="flash-item new-label">new</span>
                                    </div>
                                    <div class="wrap-btn">
                                        <a href="/client/page/detail/?id={{$product_related -> id}}" class="function-link">quick view</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    <a href="/client/page/detail/?id={{$product_related -> id}}" class="product-name"><span>{{$product_related -> name}}</span></a>
                                    @php
                                    $price_related = number_format($product_related -> price, 0, '', ',');
                                    @endphp
                                    <div class="wrap-price"><span class="product-price">{{$price_related}} (VND)</span></div>
                                </div>
                            </div>
                            @endforeach
                        </div>
