            ...
            <div class="wrap-main-slide">
                <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
                    ...
                    <div class="item-slide">
                        <img
                            src="https://res.cloudinary.com/tanvnth2012002/image/upload/v1639062480/637739131345545712_F-H1_800x300_ejjf7g.jpg"
                            alt="" class="img-slide">
                    </div>
                    <div class="item-slide">
                        <img
                            src="https://res.cloudinary.com/tanvnth2012002/image/upload/v1639062406/637738655803121919_F-H1_800x300_yrhuye.jpg"
                            alt="" class="img-slide">
                    </div>
                    <div class="item-slide">
                        <img
                            src="https://res.cloudinary.com/tanvnth2012002/image/upload/c_scale,h_600,w_1600/v1639063017/BANNER1-copy_yyjkj0.jpg"
                            alt="" class="img-slide">
                    </div>
                </div>
            </div>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{route('mobile_client.show', $mobile -> id)}}" title="{{$mobile -> name}}">
                                    <figure><img src="{{$mobile -> mainThumbnail}}" width="800"
                                                 height="800" alt="{{$mobile -> name}}"></figure>
                                </a>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{route('article_client.show', $article -> id)}}" title="{{$article -> title}}">
                                    <figure><img src="{{$article -> thumbnail}}" width="800"
                                                 height="800" alt="{{$article -> title}}"></figure>
                                </a>
                                <div class="wrap-btn">
                                    <a href="#" class="function-link">quick view</a>
                                </div>
