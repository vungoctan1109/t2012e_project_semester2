    	    ...
    	    if($("#slider-range").length > 0){
                $( "#slider-range" ).slider({
                    ...
                    slide: function( event, ui ) {
						...
						$( "#amount_max" ).val( ui.values[ 1 ].toLocaleString('it-IT', {style : 'currency', currency : 'VND'}));
						$( "#minPrice" ).val( ui.values[ 0 ] );
						$( "#maxPrice" ).val( ui.values[ 1 ] );
                    }
                });
                $( "#amount_min" ).val( $( "#slider-range" ).slider( "values", 0 ).toLocaleString('it-IT', {style : 'currency', currency : 'VND'}));
				$( "#amount_max" ).val( $( "#slider-range" ).slider( "values", 1 ).toLocaleString('it-IT', {style : 'currency', currency : 'VND'}));
            }
		},
        /* ---------------------------------------------
